...
public class SuryaNamaskarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.suryanamaskar);
        ...
        ImageView youtubeThumbnail = findViewById(R.id.youtubeThumbnail);
        youtubeThumbnail.setOnClickListener(view -> {
            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://youtu.be/_eCHrcq5wRY?si=iUvxBrmMQrZE1p2S"));
